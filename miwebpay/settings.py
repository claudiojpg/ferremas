"""
Django settings for miwebpay project.
...
SECRET_KEY = 'django-insecure-13a^zjr+0&hj^6h=udscjdhy=*-%pv&vvke0iqwg&h%1_g^ex6'
...
WSGI_APPLICATION = 'miwebpay.wsgi.application'
